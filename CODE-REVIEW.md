...
### H2. Prompt-injection surface via scraped article content -- ** FIXED ** 
- **Files:**
...
### H3. Duplicate rate limiter and robots policy per concurrent fetch track  -- ** FIXED ** 
...
### H4. URL dedup does not lowercase paths.   -- ** FIXED ** 
...
### H5. Pipeline timeout wraps work but not cleanup.   -- ** FIXED ** 
...
### H6. `main.py` is 1300+ lines and mixes many concerns.   -- ** FIXED ** 
...
### H7. Global-briefing module reaches into digest internals.  -- ** FIXED ** 
